$(function () {
    ...
    $(document).on('click', '.wc-header [class*=btnLayer]', function () {
        if ($(this).hasClass('btnLayerMid')) {
            ...
            $('.wc-chatview-panel').animate({ "height": "660px" }, "fast");
            $('.wc-chatview-panel').animate({ "bottom": '15%' }, "fast");
            ...
            $('.wc-chatview-panel').animate({ "bottom": 0 + 'px' }, "fast");
